...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <!-- header section. source: https://flowbite.com/blocks/marketing/header/ -->
        <header>
        ...
        <!-- footer section. source: https://flowbite.com/blocks/application/dashboard-footer/  -->
        <footer class="bg-white square-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
